...
r.pipe <- st_read(dsn=Intersect,layer="R_PIPELINE_SEGMENT_PERMIT_S") # multistring 
          ...
          #st_write(r.pipe.int,"Dist_R_pipe_500.shp")       #write out individual dist_layer for Range
          ...
          c.pipe.int <- st_buffer(c.pipe.int,250)
          ...
          #st_write(r.pipe.int,"Dist_C_pipe_500.shp") 
